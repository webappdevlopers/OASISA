...
public class AdminServiceListAdapter extends RecyclerView.Adapter<AdminServiceListAdapter.ViewHolder> {
    ...
    public AdminServiceListAdapter(Context context2, List<ItemsModel> mUser2) {
    ...
    public void onBindViewHolder(ViewHolder holder, int i) {
        ...
        holder.update.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(AdminServiceListAdapter.this.context, AdminUpdateItemDetailsActivity.class);
                ...
                AdminServiceListAdapter.this.context.startActivity(intent);
            }
        });
        holder.delete.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                showMe.show();
                deleteFunctionality(user_details);
    ...
    void deleteFunctionality(ItemsModel user_details) {
        ...
        Query query = myRef.orderByChild("ServiceName").equalTo(user_details.getItemName());
...
//            this.color = (TextView) itemView.findViewById(R.id.color);
            ...
            public void onResponse(String response) {
                ...
                try {
                    if (new JSONObject(response).getString(NotificationCompat.CATEGORY_STATUS).equals("200")) {
                        Toast.makeText(AdminServiceListAdapter.this.context, "Item Deleted Successfully", Toast.LENGTH_SHORT).show();
                        AdminServiceListAdapter.this.mUser.remove(i);
                        AdminServiceListAdapter.this.notifyItemRemoved(i);
                        AdminServiceListAdapter.this.notifyItemRangeChanged(i, AdminServiceListAdapter.this.mUser.size());
                        return;
                    }
                    Toast.makeText(AdminServiceListAdapter.this.context, "Something Has Happened. Please Try Again!", Toast.LENGTH_SHORT).show();
    ...
    public class getDetailsRequest extends StringRequest {
        ...
        public getDetailsRequest(String PostId, Response.Listener<String> listener) {
            ...
            Log.d("data", AdminServiceListAdapter.this.user_id + "\n" + AdminServiceListAdapter.this.hash + "\n" + PostId);
            String PostId2 = PostId.substring(1, PostId.length());
            this.parameters.put("api_key", "53rihkffdirofmbglolfhbcmfvlfjgkgnmmf");
            this.parameters.put("user_id", AdminServiceListAdapter.this.user_id);
            this.parameters.put(SessionManager.KEY_HASH, AdminServiceListAdapter.this.hash);
