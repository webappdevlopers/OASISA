...
public class AdminDriverListAdapter extends RecyclerView.Adapter<AdminDriverListAdapter.ViewHolder> implements Filterable {
    ...
    public AdminDriverListAdapter(Context context2, List<AgentDriverOrderListModel> mUser2) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                Intent intent = new Intent(AdminDriverListAdapter.this.context, Complaintdetails.class);
...
//                Log.d("getCustomerID",user_details.getCustomerID());
                AdminDriverListAdapter.this.context.startActivity(intent);
            }
        });
