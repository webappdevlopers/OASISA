...
public class RetailerEditProfileActivity extends AppCompatActivity {

    Button signin;
    Button btn_add_item;
    EditText name,mobile,shop_address,shop_name,email,gst_no;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retailer_edit_profile);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                onBackPressed();
                startActivity(new Intent(RetailerEditProfileActivity.this, RetailerProfileActivity.class));
                finish();
            }
        });
        ...
        shop_address.setText(i.getStringExtra("shop_address"));
        shop_name.setText(i.getStringExtra("shop_name"));
        email.setText(i.getStringExtra("email"));
        gst_no.setText(i.getStringExtra("gst_no"));
        ...
        image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(RetailerEditProfileActivity.this);
                        ...
                        if (options[item].equals("Take Photo")) {
                            ...
                            if (actualImage != null) {
                                ...
                                if ((Build.VERSION.SDK_INT > Build.VERSION_CODES.KITKAT)) {
                                    photoURI = FileProvider.getUriForFile(RetailerEditProfileActivity.this,
        ...
        btn_add_item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(RetailerEditProfileActivity.this, "Enter Shop Name", Toast.LENGTH_SHORT).show();
                }
                else if (name.getText().toString().isEmpty())
                {
                    Toast.makeText(RetailerEditProfileActivity.this, "Enter Name", Toast.LENGTH_SHORT).show();
                }
                else if (mobile.getText().toString().isEmpty())
                {
                    Toast.makeText(RetailerEditProfileActivity.this, "Enter Mobile Number", Toast.LENGTH_SHORT).show();
                }
                else if (email.getText().toString().isEmpty())
                {
                    Toast.makeText(RetailerEditProfileActivity.this, "Enter Email", Toast.LENGTH_SHORT).show();
                }
                else if (gst_no.getText().toString().isEmpty())
                {
                    Toast.makeText(RetailerEditProfileActivity.this, "Enter GST Number", Toast.LENGTH_SHORT).show();
                }
                else if (shop_address.getText().toString().isEmpty())
                {
                    Toast.makeText(RetailerEditProfileActivity.this, "Enter Shop Address", Toast.LENGTH_SHORT).show();
                }
                else {
                    if (imgs == null) {
    ...
    private void update_retailer() {
        ...
        final ProgressDialog showMe = new ProgressDialog(RetailerEditProfileActivity.this);
        showMe.setMessage("Please Wait");
        showMe.setCancelable(true);
        showMe.setCanceledOnTouchOutside(false);
        showMe.show();
        String url = Config.update_retailer;
        ...
        stringRequest = new StringRequest(Request.Method.POST, url,
                    ...
                    public void onResponse(String ServerResponse) {
                        ...
                        try {
                            ...
                            if (status.equals("200")) {
                                ...
                                Toast.makeText(RetailerEditProfileActivity.this, msg, Toast.LENGTH_LONG).show();
                                Intent intent = new Intent(RetailerEditProfileActivity.this, RetailerProfileActivity.class);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(RetailerEditProfileActivity.this, "Not connected to internet", Toast.LENGTH_SHORT).show();
                    }
                }) {
    ...
    private void NetworkDialog() {
        final Dialog dialogs = new Dialog(RetailerEditProfileActivity.this);
    ...
    private void requestPermission() {
        ActivityCompat.requestPermissions(RetailerEditProfileActivity.this, new String[]
