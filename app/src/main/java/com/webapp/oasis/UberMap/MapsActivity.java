package com.webapp.oasis.UberMap;
...
//            try {
//
//                String api_url = "d";//getString(R.string.server_url) + "/get_cab_location.php";
//
...
//                //progressDialog.show();
//
//                if (source_location.getText().toString().isEmpty())
//                {
//                    Toast.makeText(MapsActivity.this, "Select Source", Toast.LENGTH_SHORT).show();
//                }
//                else if (destination_location.getText().toString().isEmpty())
//                {
//                    Toast.makeText(MapsActivity.this, "Select Destination", Toast.LENGTH_SHORT).show();
//                }
//                else {
...
//                    double dest_lng ;
//                    try {
//                        src_lat = source_location_marker.getPosition().latitude;
//                         src_lng = source_location_marker.getPosition().longitude;
//
//                         dest_lat = destination_location_marker.getPosition().latitude;
//                         dest_lng = destination_location_marker.getPosition().longitude;
//
//                        Log.d("src_lat", String.valueOf(src_lat));
//                        Log.d("src_lng", String.valueOf(src_lng));
//                        Log.d("dest_lat", String.valueOf(dest_lat));
//                        Log.d("dest_lng", String.valueOf(dest_lng));
//                    }
//                    catch (Exception e){
//                        /*src_lat = Double.parseDouble(lat);
//                        src_lng = Double.parseDouble(lon);*/
//
//                        Intent intent= new Intent(MapsActivity.this, MapsActivity.class);
//                        startActivity(intent);
//                    }
//                    Intent intent= new Intent(MapsActivity.this, CustomerPlaceOrderActivity.class);
//                    intent.putExtra("source", source_location.getText().toString());
//                    intent.putExtra("destination",destination_location.getText().toString());
...
//                source_location.setText(place.getName()+place.getAddress());
//
...
//                markerOptions.title("Source:"+place.getName());
////                BitmapDrawable bitmapDrawable = (BitmapDrawable) getResources().getDrawable(R.drawable.car);
////                Bitmap b = bitmapDrawable.getBitmap();
...
//                Log.i(TAG, "Place: " + place.getName());
//
//                destination_location.setText(place.getName()+place.getAddress());
//
...
//                MarkerOptions markerOptions = new MarkerOptions();
//                markerOptions.position(latLng);
//                markerOptions.title("Destination: "+place.getName());
////                BitmapDrawable bitmapDrawable = (BitmapDrawable) getResources().getDrawable(R.drawable.car);
////                Bitmap b = bitmapDrawable.getBitmap();
////                Bitmap smallCar = Bitmap.createScaledBitmap(b, 150, 81, false);
//
...
//        try {
//            String api_url = "dd";//getString(R.string.server_url) + "/get_near_cabs.php";
//
...
//                String stateName3 = addresses.get(0).getLocality();
//                source_location.setText(cityName + ", " + stateName);
//
//                source_location.setText(cityName + ", " + stateName);
//                Log.d("source_location", String.valueOf(source_location));
//                Log.d("cityName", cityName);
//                Log.d("stateName3", stateName3);
//
//                if (source_location_marker != null) {
//                    source_location_marker.remove();
//                }
